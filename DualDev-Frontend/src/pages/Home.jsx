        ...
        {isSearching && (
          <div className="mt-4">
            ...
            <div className="flex items-center justify-center gap-3 mt-5 mb-3">
              ...
              <span className="font-mono-display text-[11px] text-[#00FF85] tracking-[3px]">SEARCHING FOR OPPONENT</span>
            </div>
            <button
              className="mt-3 bg-[#161616] text-[#E8E8E8] border border-[#2A2A2A] font-mono-display font-bold text-xs tracking-widest px-6 py-3 rounded-md hover:border-[#444] transition-all"
        ...
        {roomId && (
          <div className="inline-block bg-[#111] border border-[#2A2A2A] rounded-lg px-10 py-5 mt-4 text-center">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <button
                className="bg-[#161616] text-[#888] border border-[#2A2A2A] font-mono-display text-[11px] px-3 py-1 rounded hover:border-[#444] transition-all"
      ...
      <footer className="bg-[#0D0D0D] border-t border-[#1A1A1A] px-6 pt-12 pb-7">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-10 mb-10">
            <div>
              <span className="font-mono-display font-bold text-sm tracking-widest">
                <span className="text-[#E8E8E8]">CODE</span><span className="text-[#00FF85]">JUDGE</span>
              </span>
          ...
          <div className="border-t border-[#1A1A1A] pt-5 flex items-center justify-between">
            <span className="font-mono-display text-[11px] text-[#444]">© 2026 CodeJudge. All rights reserved.</span>
